 ...
 * Return 0: this is a pointer to the newly-allocated buffer.
 */
char *create_buffer(char *file)
{
	char *buffer;
...
/**
 * main - it copies the contents of one file to another one.
 * @argc: This are the number of arguments supplied out to the program.
