 ...
 * @e_ident: this is a pointer to an array containing the ELF's magic numbers.
...
/**
 * print_magic - it prrints the magic numbers of an ELF header.
 * @e_ident:tis is a pointer to an array containing the ELF's magic numbers.
...
/**
 * main-this displays the information that is contained in the ELF header at the start of an ELF file.
 * @argc: This is the number of arguments supplied to the program.
 * @argv: thi is an array of pointers to the arguments.
 * Return: 0 on success.
